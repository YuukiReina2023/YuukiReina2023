### 🐱 Hi there, I'm YuukiReina！👋

大家好，我是 YuukiReina，今年 16 歲。目前我正在準備返校復學，所以在這裡可能不會太活躍，不過我想大家应该也不会太介意吧 XD。

大概是受到已故姐姐的影響，我一直夢想著能成為一名可愛的貓娘工程師 (Catgirl Engineer)。這也是我開始深入探索計算機科學的原因。對我而言，這是一段充滿挑戰的旅程，雖然我目前的程式設計能力還不是很好，但我一定會努力加油的！此外，承載著身邊人們的期望，我目前也在學習 Blender 与 Adobe 相關軟體，希望有一天能成為一名優秀的動態圖形設計師 (Motion Graphics Artist)，透過精美的 3D 影片和大家分享精彩的故事。

我個人最大的夢想，是建立屬於自己的專屬數據中心 (Data Center)，並打造一套配備完善的家庭重症監護室 (Home ICU)。🏥💻

此外，我特別喜歡遊戲和貓咪 (Nekos)。( •̀ ω •́ )y

<!-- 並排展示貓貓與兔兔 -->
<table border="0">
  <tr>
    <td align="center" valign="middle">
      <img src="https://user-images.githubusercontent.com/22280294/179611382-5704fe4f-ef8c-40f2-b868-5921cfb56da6.png" alt="pusheen" height="120px" />
    </td>
    <td align="center" valign="middle">
      <a href="https://emoji.gg/emoji/34405-bunnymiku">
        <img src="https://cdn3.emoji.gg/emojis/34405-bunnymiku.gif" alt="BunnyMiku" height="120px" />
      </a>
    </td>
  </tr>
</table>
...
<details>
<summary><b>🌎 語言能力 / Languages ( 點擊展開 / Click to expand )</b></summary>
...
這裡記錄着我作為一名向往未來的工程師，正在籌划和实现的夢想：

<table border="0">
  <tr>
    <td valign="top" width="50%">
      <b>基礎設施與系統 (Infrastructure)</b>
      <br><br>
      <ul>
        <li><input type="checkbox" checked> 建立高可用性家用服務器集群</li>
        <li><input type="checkbox" checked> 優化 NixOS / Arch Linux 桌面環境配置</li>
        <li><input type="checkbox" disabled> <b>專屬數據中心 (Data Center) 搭建</b></li>
        <li><input type="checkbox" disabled> <b>家庭重症監護室 (Home ICU) 完善</b></li>
      </ul>
    </td>
    <td valign="top" width="50%">
      <b>成長與創作 (Growth & Creative)</b>
      <br><br>
      <ul>
        <li><input type="checkbox" checked> 掌握 Blender 基礎建模與渲染</li>
        <li><input type="checkbox" disabled> 創作首個 3D 動畫短片</li>
        <li><input type="checkbox" disabled> 成為一名合格的 Motion Graphics Artist</li>
        <li><input type="checkbox" disabled> 成為真正的 Catgirl Engineer (喵~)</li>
      </ul>
    </td>
  </tr>
</table>
